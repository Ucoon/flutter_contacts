...
data class Contact(
    ...
    var lastUpdateTimes: String,
    var contactTimes: Int,
    ...
    companion object {
        fun fromMap(m: Map<String, Any?>): Contact {
            return Contact(
                ...
                m["lastUsedTimes"] as String,
                m["lastUpdateTimes"] as String,
                m["contactTimes"] as Int,
                m["lastContactTime"] as String,
    ...
    fun toMap(): Map<String, Any?> = mapOf(
        ...
        "lastUsedTimes" to lastUsedTimes,
        "lastUpdateTimes" to lastUpdateTimes,
        "contactTimes" to contactTimes,
        "lastContactTime" to lastContactTime,
